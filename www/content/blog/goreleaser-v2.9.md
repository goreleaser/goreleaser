...
{{< button href="https://github.com/goreleaser/goreleaser/releases/tag/v2.9.0" label="v2.9.0 (OSS)" icon="github" primary="false" >}}
{{< button href="https://github.com/goreleaser/goreleaser-pro/releases/tag/v2.9.0" label="v2.9.0 (Pro)" icon="github" primary="false" >}}
