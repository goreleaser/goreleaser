...
the binaries generated by your `builds` section. They can also use
packages built by the [NFPM pipe](/customization/nfpm).
...
dockers:
  ...
  -
    ...
    # NFPM IDs to gather packages from. All packages from the given NFPMs will
    # be available during the Docker build.
    nfpms:
    - mynfpm
