...
func TestParse(t *testing.T) {
	for target, dst := range map[string]Target{
		...
		"linux_arm_5_softfloat": {
			Target: "linux_arm_5_softfloat",
			Goos:   "linux",
			Goarch: "arm",
			Goarm:  "5_softfloat",
		},
		"linux_arm_5_hardfloat": {
			Target: "linux_arm_5_hardfloat",
			Goos:   "linux",
			Goarch: "arm",
			Goarm:  "5_hardfloat",
		},
		"linux_arm_6_softfloat": {
			Target: "linux_arm_6_softfloat",
			Goos:   "linux",
			Goarch: "arm",
			Goarm:  "6_softfloat",
		},
		"linux_arm_6_hardfloat": {
			Target: "linux_arm_6_hardfloat",
			Goos:   "linux",
			Goarch: "arm",
			Goarm:  "6_hardfloat",
		},
		"linux_arm_7_softfloat": {
			Target: "linux_arm_7_softfloat",
			Goos:   "linux",
			Goarch: "arm",
			Goarm:  "7_softfloat",
		},
		"linux_arm_7_hardfloat": {
			Target: "linux_arm_7_hardfloat",
			Goos:   "linux",
			Goarch: "arm",
			Goarm:  "7_hardfloat",
		},
