...
func TestRelativeRemote(t *testing.T) {
	...
	// only the upstream/main ref needs to exist; fetching the real repository
	// over the network would make this test slow and dependent on github.
	testlib.GitRemoteTrackingRef(t, "upstream", "main")
