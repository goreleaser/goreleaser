...
const (
	...
	LinuxPackage
	// PushableSnap is a snapcraft package yet to be pushed
	PushableSnap
	// Snap is a snapcraft package that was pushed
	Snap
	// PushableDockerImage is a docker image that should be pushed
	PushableDockerImage
	// DockerImage is a pushed docker image
	DockerImage
