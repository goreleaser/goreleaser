...
- README.md
- www/layouts/index.html (top sponsors $50+/month only)
...
HOME_FILE = "www/layouts/index.html"
...
def generate_markdown(tiers: Dict[str, List[Dict[str, Any]]]) -> str:
    ...
    has_logo_sponsors = any(tiers.get(t) for t in logo_tiers)

    if has_logo_sponsors:
        lines.append('<div class="goreleaser-sponsors-tiers">')
        lines.append("")
